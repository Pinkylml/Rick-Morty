...
export const Graphs = ({ characters, totalInfo }) => {
    ...
    return (
        <div className="max-w-6xl mx-auto mb-8 p-4">
            ...
            <h1 className="text-2xl font-bold text-center mb-6 text-gray-800">Current Page Informationc</h1>
            <h2 className="text-lg font-semibold mb-4 text-center">Character statisctic</h2>
